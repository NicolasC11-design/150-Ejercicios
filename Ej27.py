def busqueda_binaria(lista, elemento_buscado):
    """Implementa búsqueda binaria. La lista debe estar ordenada previamente."""
    izquierda = 0
    derecha = len(lista) - 1
    iteraciones = 0
...
print("\nConclusión:")
print("✔ Ventaja de búsqueda binaria: Menos comparaciones en listas grandes (si la lista está ordenada).")